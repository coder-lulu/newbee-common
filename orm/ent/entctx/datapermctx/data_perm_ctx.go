...
func GetScopeFromCtx(ctx context.Context) (uint8, error) {
	...
	if scope, ok = ctx.Value(ScopeKey).(string); !ok {
		if md, ok := metadata.FromIncomingContext(ctx); !ok {
            ...
            return 0, fmt.Errorf("invalid argument: failed to get data scope")
		} else {
...
func GetCustomDeptFromCtx(ctx context.Context) ([]uint64, error) {
	...
	if customDept, ok = ctx.Value(CustomDeptKey).(string); !ok {
		if md, ok := metadata.FromIncomingContext(ctx); !ok {
            ...
            return nil, fmt.Errorf("invalid argument: failed to get custom departmrnt ids")
		} else {
...
func GetSubDeptFromCtx(ctx context.Context) ([]uint64, error) {
	...
	if subDept, ok = ctx.Value(SubDeptKey).(string); !ok {
		if md, ok := metadata.FromIncomingContext(ctx); !ok {
            ...
            return nil, fmt.Errorf("invalid argument: failed to get sub departmrnt ids")
		} else {
...
func GetFilterFieldFromCtx(ctx context.Context) (string, error) {
	if filterField, ok := ctx.Value(FilterFieldKey).(string); !ok {
		if md, ok := metadata.FromIncomingContext(ctx); !ok {
            ...
            return "", fmt.Errorf("invalid argument: failed to get filter field")
		} else {
...
func GetUserIDFromCtx(ctx context.Context) (string, error) {
	...
	if !found || userID == "" {
        ...
        return "", fmt.Errorf("invalid argument: failed to get user id")
	}
...
func GetUserDeptFromCtx(ctx context.Context) (uint64, error) {
	...
	if !found || deptIDStr == "" {
        ...
        return 0, fmt.Errorf("invalid argument: failed to get user dept id")
	}
